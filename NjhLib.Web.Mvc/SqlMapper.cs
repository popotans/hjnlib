...
namespace Doodle.Core
{
    ...
    public static class SqlMapper
    {
        ...
        static SqlMapper()
        {
            ...
            typeMap[typeof(bool)] = DbType.UInt64;
        ...
        /// </summary>
        /// <remarks>the dynamic param may seem a bit odd, but this works around a major usability issue in vs, if it is Object vs completion gets annoying. Eg type new <space> get new object</space></remarks>
        ...
        static IEnumerable<TReturn> MultiMap<TFirst, TSecond, TThird, TFourth, TFifth, TReturn>(this IDbConnection cnn, string sql, object map, object param, IDbTransaction transaction, bool buffered, string splitOn, int? commandTimeout, CommandType? commandType)
        {
...
#pragma warning restore 618
        ...
        /// <returns></returns>
        public static Func<IDataReader, object> GetClassDeserializer(Type type, IDataReader reader, int startBound, int length, bool returnNullIfFirstMissing)
        {
        ...
        public class GridReader : IDisposable
        {
            ...
            /// <param name="deserializerGenerator"></param>
            /// <returns></returns>
