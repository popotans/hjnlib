...
<head>
 ...
 <script type="text/javascript">
     $(document).ready(function () {
         ...
         $("#img1").click(function () {
             tipsWindown("图片", "img:http://www.code-design.cn/imgdesign/20090625/2009625152158343.jpg", "500", "230", "true", "", "true", "img")
         });

         $("#url1").click(function () {
             tipsWindown("标题", "url:get?test.htm", "250", "150", "true", "", "true", "text");
         });

         $("#iframe1").click(function () {
             tipsWindown("标题", "iframe:http://www.baidu.com", "950", "527", "true", "", "true", "leotheme");
         });
     });
 </script>
</head>
...
<div id="container">
  ...
  <h3>应用演示：</h3>
    <ol>
		...
		<blockquote>tipsWindown("标题","url:test.htm","250","150","true","","true","text"); </blockquote>
		...
		<li>
		加载一个页面到框架显示：<br /> 
		<blockquote>tipsWindown("标题","iframe:http://baidu.com","900","580","true","","true","leotheme"); </blockquote>
