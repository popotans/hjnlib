...
namespace NjhLib.Utils
{
    ...
    {
        bool isLeaf();
        object Element { get; set; }      IBinNode Left { get; set; }      IBinNode Right { get; set; }
    }  //遍历，线索化等操作的接口  
    interface ITravelBinTree
    {
        void PreOrderTravel(); void InOrderTravel(); void RevOrderTravel(); void Print(IBinNode t);
    }
    ...
    IBinNode
    {
        ...
        protected IBinNode lchild; protected IBinNode rchild;
        ...
        public object Element { get { return element; } set { element = value; } }
        public IBinNode Left { get { return lchild; } set { lchild = value; } }
        public IBinNode Right { get { return rchild; } set { rchild = value; } }
    }
    class BinNodeLine : BinNodePtr, IBinNode
    {
        ...
        public BinNodeLine(object e, IBinNode left, IBinNode right)
            : base(e, left, right)
        { ltag = rtag = Tag.LINK; } public BinNodeLine(object e) : base(e) { ltag = rtag = Tag.LINK; }
        public Tag LTag { get { return ltag; } set { ltag = value; } }
        public Tag RTag { get { return rtag; } set { rtag = value; } }
    }
    ...
    {
        const int INIT_TREE_SIZE = 20; private IBinNode tree;
        private BinNodeLine head;
        //线索化后的头指针
        private IBinNode prenode;
        //指向最近访问过的前驱节点   
        ...
        {
            if (t == null) return; InOrderTravel(t.Left);
            Print(t); InOrderTravel(t.Right);
        }
        ...
        {
            Stack stk = new Stack(INIT_TREE_SIZE);
            stk.Push(tree); Position pos;
            string para; pos = Position.LEFT;
            IBinNode baby, temp;
            // baby = new object();
            while (true)
            {
                ...
                else
                {
                    ...
                    baby = new BinNodePtr(para); temp = (IBinNode)stk.Peek();
                    if (pos == Position.LEFT) temp.Left = baby;
                    else temp.Right = baby; pos = Position.LEFT;
                    stk.Push(baby);
                }
            }
        }      //中序线索化  
