...
namespace NjhLib.Utils.DB
{
    ...
    {
        // Fields
        public static string connStr = ConfigurationManager.ConnectionStrings["connStrSql"].ConnectionString;
        ...
        public static void WriteLog(string Msg)
        {
            ...
            builder.Append("insert into WrongLog(");
            builder.Append("LogId,LogMsg,LogType,HappenTime,Status");
            builder.Append(")");
            builder.Append(" values (");
            builder.Append(GetMaxID("Logid", "WrongLog") + ",");
            builder.Append("'" + Msg.Trim().Replace("'", "''") + "',");
            builder.Append("'1',");
