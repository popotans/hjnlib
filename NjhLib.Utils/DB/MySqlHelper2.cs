...
namespace NjhLib.Utils.DB
{
    ...
    public class MySqlHelper2
    {
        ...
        #region  public static bool ExecuteNonQuery(CommandType cmdType, string cmdText, params MySqlParameter[] commandParameters) //ExecuteScalar
        //-----------------------------------------------------------------------------------------
        /// <summary>
        /// ExecuteScalar
        /// </summary>
        ...
        #region  public static bool ExecuteNonQuery(string connString, CommandType cmdType, string cmdText, params MySqlParameter[] commandParameters) //重载：ExecuteScalar
        //-----------------------------------------------------------------------------------------
        /// <summary>
        /// 重载：ExecuteScalar
        /// </summary>
